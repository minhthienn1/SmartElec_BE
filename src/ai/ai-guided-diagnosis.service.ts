  ...
  resolveNextStep(input: GuidedDiagnosisInput): AiGuidedDiagnosisResult {
    ...
    const baseState = {
      ...
      askedFollowupKey: questionSetMatches
        ...
        : null,
      risk: mergedContextAnswers.safetySigns ? 'RED' : previousState.risk || 'UNKNOWN',
    ...
    const templates: Record<string, QuestionTemplate> = {
      ...
      'COOLING_HEATING::REFRIGERATOR_COOLING': {
        ...
        followups: {
          ...
          abnormalSigns: 'Tủ có đóng tuyết bất thường, quạt yếu hoặc ron cửa hở không?',
        },
      },
      'WATER_APPLIANCE::GENERIC': {
        ...
        followups: {
          operationStatus: 'Thiết bị đang lỗi rõ nhất ở bước nào: cấp nước, chạy chính hay xả nước?',
      ...
      'COOKING_APPLIANCE::GENERIC': {
        ...
        followups: {
          operationStatus: 'Thiết bị có lên nguồn nhưng không nóng, hay không lên nguồn hoàn toàn?',
      ...
      'DISPLAY_AUDIO::GENERIC': {
        ...
        followups: {
          operationStatus: 'Thiết bị hiện còn lên nguồn hay hoàn toàn không có đèn báo?',
          whenHappens: 'Lỗi bắt đầu sau sự kiện nào gần đây như mất điện, va đập hoặc cập nhật?',
        },
      },
      'CLEANING_APPLIANCE::GENERIC': {
        ...
        followups: {
          operationStatus: 'Máy hiện không chạy hoàn toàn hay vẫn chạy nhưng hút yếu?',
      ...
      'AIR_WATER_TREATMENT::GENERIC': {
        ...
        followups: {
          ...
          whenHappens: 'Lỗi xuất hiện sau lần thay lõi/vệ sinh gần nhất hay đang dùng bình thường?',
        },
      },
      'GENERIC_APPLIANCE::GENERIC': {
        ...
        followups: {
          operationStatus: 'Thiết bị hiện còn lên nguồn hoặc hoạt động được phần nào không?',
